...
const API_URL = "https://bryanhoulton--aryan-tutor-aryantutor-serve.modal.run";

const DEMO_CONFIG = {
  name: "Aryan's Tutor",
  description:
    "An AI tutor with 2,000+ memories from tutoring sessions - covering math, reading, and science.",
  placeholder: "Ask about past lessons or continue tutoring...",
  suggestedQuestions: [
    "What topics has Aryan been working on in math?",
    "How is Aryan doing with fractions?",
    "What reading passages have we covered?",
    "What areas does Aryan need more practice in?",
  ],
};

export default function AryanDemo() {
                    ...
                    <div className="pl-1">
                      ...
                      {msg.hitMaxTokens && (
                        <p className="text-orange-500 text-sm mt-2 italic">
                          Warning: Response truncated (hit token limit)
                        </p>
                      )}
